...
/*   Updated: 2025/05/05 09:22:17 by rguigneb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	draw_incrementor(cub3d, "F O V :", (int *)&cub3d->settings.fov, 1, 0);
	draw_incrementor(cub3d, "J S P :", (int *)&cub3d->settings.jsp, 1, 3);
