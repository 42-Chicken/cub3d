...
void	update_loading_screen(t_cub3d *cub3d)
{
	...
	{
		draw_rect(loading_screen, 0x36454f, (t_uvec2){SCREEN_W / 8, SCREEN_H
			- 30}, (t_uvec2){SCREEN_W - SCREEN_W / 8, SCREEN_H - 20});
		draw_rect(loading_screen, 0x708090, (t_uvec2){SCREEN_W / 8, SCREEN_H
			- 30}, (t_uvec2){SCREEN_W / 8 + (SCREEN_W / __TEXTURES_COUNT__
				/ 1.5) * cub3d->textures_loaded, SCREEN_H - 20});
