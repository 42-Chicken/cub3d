...
{
	trashcan->textures[CUB3D_ENTITY_TEXTURE_FRONT] = \
	TEXTURE_ENTITY_TRASHCAN;
	trashcan->textures[CUB3D_ENTITY_TEXTURE_FRONT_RIGHT] = \
	TEXTURE_ENTITY_TRASHCAN;
	trashcan->textures[CUB3D_ENTITY_TEXTURE_RIGHT] = \
	TEXTURE_ENTITY_TRASHCAN;
	trashcan->textures[CUB3D_ENTITY_TEXTURE_BACK_RIGHT] = \
	TEXTURE_ENTITY_TRASHCAN;
	trashcan->textures[CUB3D_ENTITY_TEXTURE_BACK] = \
	TEXTURE_ENTITY_TRASHCAN;
	trashcan->textures[CUB3D_ENTITY_TEXTURE_BACK_LEFT] = \
	TEXTURE_ENTITY_TRASHCAN;
	trashcan->textures[CUB3D_ENTITY_TEXTURE_LEFT] = \
	TEXTURE_ENTITY_TRASHCAN;
	trashcan->textures[CUB3D_ENTITY_TEXTURE_FRONT_LEFT] = \
	TEXTURE_ENTITY_TRASHCAN;
}
