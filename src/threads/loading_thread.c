...
/*   Updated: 2025/05/05 10:01:22 by rguigneb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		return (NULL);
// 	while (r_size_t(&cub3d->mutex, &cub3d->textures_loaded) != __TEXTURES_COUNT__)
// 	{
...
bool init_loading_thread(t_cub3d *cub3d)
{
	...
	// if (pthread_create(&cub3d->loading_thread, NULL, loading_thread_routine, cub3d) == -1)
